...
import pix1 from "../../assets/image.png";
...
const ReportCardShow: FC<iSchool> = ({
  schoolName,
  schoolAddress,
  studentDetails,
  subjects,
  ...
  return (
    <div className="mx-auto bg-white p-8 shadow-md rounded-lg flex justify-center items-center">
      <div className="w-[60%] min-h-[100vh] shadow lg:p-5">
        <div className="h-[200px] w-full flex justify-center items-center gap-3 overflow-y-auto">
          <div className="h-[200px] w-[100%] border-b-2 border-b-gray-400 flex justify-between items-center gap-3 p-3 px-4">
            <div className="lg:w-[14%] w-[25%] lg:h-[100px] h-[70px] flex justify-center items-center border-none">
              <img src={pix} alt="" className="h-[100%] w-[100%]" />
            </div>
            <div className="w-[70%] h-[100px]">
              <h1 className="font-bold text-center lg:text-[27px] text-[14px] ">
                {schoolName}
              </h1>
              <p className="text-center text-[14px]">{schoolAddress}</p>
            </div>
            <div className="w-[20%] lg:h-[190px] flex justify-center items-center">
              <img
                src={pix1}
                alt=""
